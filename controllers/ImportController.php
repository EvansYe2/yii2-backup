...
namespace evans\backup\controllers;
 ...
 * Time: 下午4:02
 */
use evans\backup\models\Database;
...
class ImportController extends Controller
{
    ...
    public function actionDel()
    {
        ...
        if($time){
            ...
            if(count(glob($path))){
                return ['status'=>0,'info' => '备份文件删除失败，请检查权限!'];
//                throw new Exception('备份文件删除失败，请检查权限!');
            } else {
                return ['status'=>1,'info' => '备份文件删除成功!'];
            }
        } else {
            throw new Exception('参数错误!');
        }
